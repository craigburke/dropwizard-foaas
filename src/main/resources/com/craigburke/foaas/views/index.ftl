...
<div class="container">
    <div class="hero-unit">
        ...
        <p>A DropWizard FOAAS implementation based on <a href="http://www.foaas.com">FOAAS v0.0.1</a></p>

        <p><strong>Note:</strong> this is not my idea, just my implementation. See <a href="#credits">credits</a> for more details</p>

        <p><a href="https://github.com/craigburke/dropwizard-foaas" class="btn btn-primary"><i class="icon-file icon-white"></i> View the source on github</a></p>
...
<div class="container">
    <div class="content" style="margin-left:50px;">
        ...
        <p>This is all based off of the concept and API designed by Dionysus (<a href="https://twitter.com/foaas">@foaas</a>). This was ported to a DropWizard app by <a href="http://www.craigburke.com">Craig Burke</a> (<a href="https://twitter.com/craigburke1">@craigburke1</a>).</p>
